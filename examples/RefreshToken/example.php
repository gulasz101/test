...
$provider->setRefreshToken(
    env('REFRESH_TOKEN', function (): void {
        throw new InvalidArgumentException('REFRESH_TOKEN');
    })
);

$endpoint = new \Pingen\Endpoints\UserAssociationsEndpoint($provider);
